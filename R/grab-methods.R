...
#' grab_unit_weights
#'
#' Extract the unit weights generated by `generate_weights()` from the `synth_tbl`.
#'
...
#' grab_outcome
#'
#' Extract a data frame containing the outcome variable from the `synth_tbl`.
#'
#' @param data nested data of type `synth_tbl`
#' @param type string specifying which version of the data to extract: "treated"
#'   or "control". Default is "treated".
...
#' grab_loss
#'
#' Extract the RMSE loss of the optimized weights from the `synth_tbl`.
#'
#' @param data nested data of type `synth_tbl`
#'
#' @return tibble data frame
...
#' `generate_control()` from the `synth_tbl`.
#'
#' @param data nested data of type `synth_tbl`
#' @param placebo boolean flag; if TRUE placebo values are returned as well (if
#'   available). Default is FALSE.
...
#' be adjusted to accomodate the low total rank. This is a bug of rank based
#' siginificance metrics.
#'
